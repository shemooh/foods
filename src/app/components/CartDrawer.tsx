  ...
  return (
    <>
      <style>{`
        ...
        .drawer {
          position: fixed;
          /* On mobile: slide up from bottom as a sheet */
          bottom: 0; left: 0; right: 0;
          height: 92svh; /* leaves a peek gap at top */
          width: 100%;
          background: #fff;
        ...
        .drawer-close {
          ...
          margin: -0.5rem -0.5rem -0.5rem 0; /* optical alignment */
        }
        .drawer-close:hover { background: #e8e8e8; color: #000; }
        .drawer-close:active { background: #ddd; }
        ...
        .d-emoji {
          font-size: 1.75rem; filter: grayscale(1);
          flex-shrink: 0; line-height: 1; margin-top: 2px;
        }
        .d-info { flex: 1; min-width: 0; }
        .d-name {
          font-size: 0.84rem; font-weight: 700; color: #000;
        ...
        .d-total-val {
          font-size: 1.35rem; font-weight: 900; color: #000; letter-spacing: -0.04em;
        }
        .d-checkout {
          width: 100%; background: #000; color: #fff; border: none;
          /* 52px height — comfortable mobile tap target */
          padding: 0.9rem;
        ...
        .d-checkout:hover { opacity: 0.8; }
        .d-checkout:active { opacity: 0.6; }
        ...
        .d-viewcart {
          ...
          padding: 0.4rem 0; /* extra tap area */
          -webkit-tap-highlight-color: transparent;
        }
        ...
        @media (min-width: 641px) {
          ...
          .drawer-head { padding: 1.25rem 1.5rem; }
          ...
          .drawer-close:hover { background: none; }
        }
      `}</style>
            ...
            cart.map((item) => (
              <div key={item.id} className="d-item">
                ...
                <div className="d-right">
                  ...
                  <button className="d-remove" onClick={() => removeFromCart(item.id)}>
                    Remove
                  </button>
                </div>
              </div>
